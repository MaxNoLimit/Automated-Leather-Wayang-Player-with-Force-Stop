...
{
    digitalWrite(WAYANG_HAND_6, HIGH);
    Servo_Sugriwa.moveWhatServo(1, 30, 200);
    Servo_Sugriwa.moveWhatServo(2, 120, 200);
    Servo_Sugriwa.moveWhatServo(1, 180, 300);
    Servo_Sugriwa.moveWhatServo(2, 140, 200);
    digitalWrite(WAYANG_HAND_6, LOW);
}
...
void Sugriwa::downFront()
{
    ...
    Servo_Sugriwa.moveWhatServo(2, 95, 200);
    digitalWrite(WAYANG_HAND_6, LOW);
}
...
void Sugriwa::pointToBack()
{
    ...
    Servo_Sugriwa.moveWhatServo(3, 0, 500);
...
void Sugriwa::onHipBack()
{
    ...
    Servo_Sugriwa.moveWhatServo(3, 80, 500);
...
{
    digitalWrite(WAYANG_HAND_6, HIGH);
    Servo_Sugriwa.moveWhatServo(3, 110, 500);
    Servo_Sugriwa.moveWhatServo(4, 60, 200);
